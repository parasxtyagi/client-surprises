...
interface EnhancedLoveCarouselProps {
  onNext: () => void
}

export default function EnhancedLoveCarousel({ onNext }: EnhancedLoveCarouselProps) {
  ...
  return (
    <div className="min-h-screen p-4 flex flex-col justify-center pt-20 pb-24">
      <motion.h2
      ...
      <div className="max-w-md mx-auto mb-8">
        <Card className="bg-gradient-to-br from-pink-50 to-rose-50 dark:from-pink-900/20 dark:to-rose-900/20 border-pink-200 dark:border-pink-800 shadow-xl min-h-[200px] flex items-center">
          <CardContent className="p-6 w-full">
            <div className="flex items-center justify-between mb-4">
              <Button
                ...
                size="sm"
                onClick={prevReason}
                className="text-pink-500 hover:text-pink-600 hover:bg-pink-100 dark:hover:bg-pink-900"
              >
            ...
            <div className="flex justify-center mt-4">
              <Button
                ...
                className="text-pink-500 hover:text-pink-600 hover:bg-pink-100 dark:hover:bg-pink-900 text-xs"
              >
      ...
      <div className="max-w-lg mx-auto mb-8">
        <h3 className="text-xl font-semibold text-pink-600 dark:text-pink-400 mb-4 text-center">
