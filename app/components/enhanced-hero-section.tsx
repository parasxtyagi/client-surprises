...
export default function EnhancedHeroSection({ onNext }: EnhancedHeroSectionProps) {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 text-center pt-20 pb-24">
      <motion.div
      ...
      <motion.h1
        ...
        className="text-3xl sm:text-4xl md:text-6xl font-bold text-pink-600 dark:text-pink-400 mb-4 font-serif px-4"
      ...
      <motion.div
        ...
        className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-4 sm:p-6 shadow-lg border border-pink-200 dark:border-pink-800 mb-8 max-w-sm sm:max-w-md mx-4"
      >
        <motion.p
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
